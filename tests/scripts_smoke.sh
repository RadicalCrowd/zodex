...
assert_contains scripts/build-zodex-arch-candidate.sh '^PACKAGE_MAINTAINER="RadicalCrowd Zodex Maintainers"'
assert_contains scripts/build-zodex-arch-candidate.sh '^PACKAGE_URL="https://github.com/RadicalCrowd/zodex"'
assert_contains scripts/build-zodex-arch-candidate.sh '^PACKAGE_PACKAGER="RadicalCrowd Zodex Maintainers <RadicalCrowd@users.noreply.github.com>"'
