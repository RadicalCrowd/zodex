...
test("model picker groups classifies models correctly by provider prefix", () => {
  ...
  assert.equal(classifyModelGroup({ id: "omniroute-oauth/opencode/x-preview-f-free" }), "OpenCode Free");
  assert.equal(classifyModelGroup({ id: "omniroute-oauth/kilo/stepfun/step-3.7-flash:free" }), "Kilo Free");
